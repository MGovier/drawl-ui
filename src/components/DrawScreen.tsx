...
function DrawScreen() {
  ...
  return (
    <div id="content-window">
      ...
      <p style={{ textAlign: 'center' }}>One Child Policy</p>
      ...
      <CanvasDraw
        ...
        disabled={disabled}
      />
      <button type="button" className="nes-btn is-primary" disabled={disabled} onClick={() => { saveDrawing() }} style={{ margin: '0 auto', display: 'block' }}>
        {buttonText}
      </button>
    </div>
  )
